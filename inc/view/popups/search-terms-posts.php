...
?>
<div id="search-terms-posts" class="seoaic-modal">
    ...
    <div class="seoaic-popup">
        <div class="seoaic-popup__header">
            ...
            <h3 class="modal-title" data-title="<?=__( 'Created Posts', 'seoaic'); ?>"><?=__( 'Confirm', 'seoaic'); ?></h3>
        </div>
        <div class="seoaic-popup__content fs-18">
            <div id="confirm-modal-content" class="modal-content-parse"></div>
        ...
        <div class="seoaic-popup__footer flex-justify">
            ...
            <button type="button" class="seoaic-popup__btn seoaic-popup__btn-right seoaic-modal-close"><?= __( 'Done', 'seoaic' ); ?></button>
        </div>
    </div>
</div>
