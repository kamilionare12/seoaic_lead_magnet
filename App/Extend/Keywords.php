...
class Keywords extends \SEOAIC\SEOAIC_KEYWORDS
{
    ...
    public function makeKeywordsTableMarkup($keywords = [])
    {
        ...
        ?>
        <div id="seoaic-admin-container" class="seoai-front-wrap wrap">
            <div id="seoaic-admin-body" class="seoaic-with-loader keywords">
                <div class="inner">

                    <div class="top">
                        <div class="search seoaic-mr-20">
                            <input id="keywords_search_input" type="text" placeholder="Enter a keyword"
                        ...
                        ><span class="vertical-align-middle dashicons dashicons-plus-alt2"></span>
                            <div class="dn edit-form-items">
                                <input type="hidden" name="item_name" value=""
                                       data-label="Add keywords (separated by comma). Ex: cup,table">
                                <input type="hidden" name="action" value="seoaic_add_keyword">
                            </div>
                        </button>

                        <a href="#"
                           class="seoaic_update_keywords seoaic-ajax-button small-btn <?php esc_attr_e($mu, 'seoaic'); ?>"
                    ...
                    <div class="bottom">
                        <div class="seoaic-keywords-table">
                            ...
                            if (!empty($keywords)) {
                                    ...
                                    <div class="row-line-container">
                                        ...
                                        <div class="category text-center">
                                            ...
                                            <select id="category-filter">
                                                <option value="_all"
                                                        selected><?php _e('All Clusters', 'seoaic'); ?></option>
                                        ...
                                        <div class="search-intent">
                                            ...
                                            <select id="intent-filter">
                                                <option value=""
                                                        selected><?php _e('All Search Intent', 'seoaic'); ?></option>
                                ...
                                <?php
                                echo parent::makeKeywordsTableMarkup();
                            } else {
    ...
    {
        $Keywords = new self();
        add_shortcode('seoaic_keywords_shortcode', [$Keywords, 'makeKeywordsTableMarkup']);
    }
}

Keywords::register_shortcode();